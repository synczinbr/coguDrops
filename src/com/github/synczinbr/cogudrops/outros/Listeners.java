...
public class Listeners implements Listener {
	...
	private String actionbarMessage = Drops.getInstance().getConfig().getString("actionbar.msg");
	...
	public void onRedMushroom(BlockBreakEvent e) {
	    ...
	    if (block.getType() == Material.RED_MUSHROOM) {
	        ...
	        if(useActionbar == true) {
	        	ActionBarAPI.sendActionBarMessage(e.getPlayer(), ChatColor.translateAlternateColorCodes('&', actionbarMessage));
	        }       
	}
	}
